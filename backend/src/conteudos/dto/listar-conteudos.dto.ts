...
export class ListarConteudosDto {
  @IsOptional()
  ...
  @IsEnum(OrdenacaoConteudo, { message: 'Ordenação de conteúdo inválida.' })
  ordenarPor?: OrdenacaoConteudo = OrdenacaoConteudo.VIRAL;
